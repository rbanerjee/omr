...
bool isLoggingEnabled(TR::Compilation *comp);

void updateNodeState(TR::Node *node, NodeSideTable<NodeState>  &nodeStates,
                     LiveNodeWindow &liveNodes, TR::Compilation *comp);

void checkCondition(TR::Node *node, bool condition, TR::Compilation *comp,
...
//_isValidSoFar ought to be removed from the Validator.
